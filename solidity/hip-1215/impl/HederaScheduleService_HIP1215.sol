...
abstract contract HederaScheduleService_HIP1215 {
    ...
    address private constant scheduleSystemContractAddress = address(0x16b);
    ...
    function scheduleCall(address to, uint256 expiry, uint256 gasLimit, uint64 value, bytes memory callData) internal returns (int64 responseCode, address scheduleAddress) {
