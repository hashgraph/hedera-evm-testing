...
contract TokenCreateContract is HederaTokenService, ExpiryHelper, KeyHelper {
    ...
    function createFungibleTokenPublic(address treasury) public payable returns (address) {
        ...
        return createFungibleToken(treasury, keys);
    }

    function createFungibleTokenWithoutKYCPublic(address treasury) public payable returns (address) {
    ...
    function createFungibleTokenWithSECP256K1AdminKeyPublic(address treasury, bytes memory adminKey) public payable returns (address) {
        IHederaTokenService.TokenKey[] memory keys = new IHederaTokenService.TokenKey[](6);
    ...
    function createFungibleTokenWithSECP256K1AdminKeyWithoutKYCPublic(address treasury, bytes memory adminKey) public payable returns (address) {
        IHederaTokenService.TokenKey[] memory keys = new IHederaTokenService.TokenKey[](4);
        keys[0] = getSingleKey(KeyType.ADMIN, KeyType.PAUSE, KeyValueType.SECP256K1, adminKey);
    ...
    // ---------------------------------- NFT ----------------------------------
    function createNonFungibleToken(address treasury, IHederaTokenService.TokenKey[] memory keys) internal returns (address) {
        IHederaTokenService.Expiry memory expiry = IHederaTokenService.Expiry(
            0, treasury, 8000000
        );
    ...
    function createNonFungibleTokenPublic(address treasury) public payable returns (address) {
        ...
        return createNonFungibleToken(treasury, keys);
    }

    function createNonFungibleTokenWithoutKYCPublic(address treasury) public payable returns (address) {
        IHederaTokenService.TokenKey[] memory keys = new IHederaTokenService.TokenKey[](4);
        keys[0] = getSingleKey(KeyType.ADMIN, KeyType.PAUSE, KeyValueType.INHERIT_ACCOUNT_KEY, bytes(""));
        keys[1] = getSingleKey(KeyType.FREEZE, KeyValueType.INHERIT_ACCOUNT_KEY, bytes(""));
        keys[2] = getSingleKey(KeyType.SUPPLY, KeyValueType.INHERIT_ACCOUNT_KEY, bytes(""));
    ...
    function createNonFungibleTokenWithSECP256K1AdminKeyPublic(address treasury, bytes memory adminKey) public payable returns (address) {
        IHederaTokenService.TokenKey[] memory keys = new IHederaTokenService.TokenKey[](6);
        keys[0] = getSingleKey(KeyType.ADMIN, KeyType.PAUSE, KeyValueType.SECP256K1, adminKey);
        keys[1] = getSingleKey(KeyType.KYC, KeyValueType.SECP256K1, adminKey);
        keys[2] = getSingleKey(KeyType.FREEZE, KeyValueType.SECP256K1, adminKey);
    ...
    function createNonFungibleTokenWithSECP256K1AdminKeyWithoutKYCPublic(address treasury, bytes memory adminKey) public payable returns (address) {
        IHederaTokenService.TokenKey[] memory keys = new IHederaTokenService.TokenKey[](4);
        keys[0] = getSingleKey(KeyType.ADMIN, KeyType.PAUSE, KeyValueType.SECP256K1, adminKey);
        keys[1] = getSingleKey(KeyType.FREEZE, KeyValueType.SECP256K1, adminKey);
        keys[2] = getSingleKey(KeyType.SUPPLY, KeyValueType.SECP256K1, adminKey);
    ...
    function grantTokenKycPublic(address token, address account) external returns (int256 responseCode) {
    ...
    function updateTokenInfoPublic(address token, IHederaTokenService.HederaToken memory tokenInfo) external returns (int256 responseCode) {
    ...
    function approveNftPublic(address token, address spender, uint256 serialNumber) public returns (int256 responseCode) {
    ...
    function transferTokenPublic(address tokenAddress, address receiver, int64 amount) public returns (int256 responseCode) {
